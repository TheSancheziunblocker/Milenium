local function r0_0(r0_268, r1_268, r2_268)
  ...
  local function espcuh()
    ...
    local r7_0 = {
      ...
      NotVisibleColor = Color3.fromRGB(0, 255, 0),
      WhitelistESPColor = Color3.fromRGB(0, 180, 255),
    ...
    highlightContainer.Name = "LirpESPHighlights"
    highlightContainer.Parent = r1_0
    ...
    local function IsPartVisibleFromCamera(part)
      local origin = r5_0.CFrame.Position
      local direction = part.Position - origin
      local params = RaycastParams.new()
      local filterList = { r5_0 }
      if r4_0.Character then
        table.insert(filterList, r4_0.Character)
      end
      params.FilterDescendantsInstances = filterList
      params.FilterType = Enum.RaycastFilterType.Exclude
      local result = r1_0:Raycast(origin, direction, params)
      if result then
        return result.Instance:IsDescendantOf(part.Parent)
          or result.Instance.Parent == part.Parent
          or result.Instance == part
      end
      return true
    end
    local function GetESPColorForPlayer(player, rootPart)
      if player and IsWhitelisted and IsWhitelisted(player) then
        return r7_0.WhitelistESPColor
      end
      if r7_0.UseVisibilityColors and rootPart then
        if IsPartVisibleFromCamera(rootPart) then
          return r7_0.VisibleColor
        end
        return r7_0.NotVisibleColor
      end
      return nil
    end
    local function GetOrCreateHighlight(charModel)
      if playerHighlights[charModel] then
        return playerHighlights[charModel]
      end
      local hl = Instance.new("Highlight")
      hl.Name = "LirpESPHighlight"
      hl.Adornee = charModel
      hl.FillColor = r7_0.VisibleColor
      hl.OutlineColor = r7_0.VisibleColor
      hl.FillTransparency = 0.5
      hl.OutlineTransparency = 0
      hl.DepthMode = Enum.HighlightDepthMode.AlwaysOnTop
      hl.Enabled = false
      hl.Parent = highlightContainer
      playerHighlights[charModel] = hl
      return hl
    end
    local function RemoveHighlight(charModel)
      if playerHighlights[charModel] then
        pcall(function() playerHighlights[charModel]:Destroy() end)
        playerHighlights[charModel] = nil
      end
    end
        ...
        if r5_3 and (not r7_0.TeamCheck or r4_0.Team and r3_3.Team ~= r4_0.Team) then
          ...
          if r6_3 then
            ...
            if r8_3 then
              ...
              local r18_3 = GetESPColorForPlayer(r3_3, r6_3)
              local r19_3 = false
              if r6_3 and not (IsWhitelisted and IsWhitelisted(r3_3)) then
                if r7_0.UseVisibilityColors or r7_0.VisibleHighlight then
                  r19_3 = IsPartVisibleFromCamera(r6_3)
                end
              end
              r4_3.Data = {
                HRP2D = r7_3,
                ...
                ESPColor = r18_3,
                IsVisible = r19_3,
                IsWhitelisted = IsWhitelisted and IsWhitelisted(r3_3) or false,
              }
    ...
    local function r12_0()
      ...
      for r3_6, r4_6 in pairs(r6_0) do
        ...
        if r5_6 and r5_6.OnScreen and r7_0.Enabled then
          ...
          local r14_6 = r5_6.ESPColor
          local r15_6 = r14_6 or r7_0.BoxColor
          local r16_6 = r14_6 or r7_0.SkeletonsColor
          if r7_0.ShowBox then
            r4_6.Box.Size = r7_6
            r4_6.Box.Position = r6_6
            r4_6.Box.Color = r15_6
          ...
          if r7_0.ShowHealth then
            local r8_6 = r5_6.HealthPercentage or 0
            ...
            r4_6.Health.Color = GetHealthColor(r8_6)
          ...
          if r7_0.ShowName then
            local r17_6 = string.lower(r3_6.Name)
            if r5_6.IsWhitelisted then
              r17_6 = "[wl] " .. r17_6
            end
            r4_6.Name.Text = r17_6
          ...
          local r18_6 = r3_6.Character
          if r18_6 then
            if r7_0.VisibleHighlight and r5_6.IsVisible and not r5_6.IsWhitelisted then
              local hl = GetOrCreateHighlight(r18_6)
              hl.FillColor = r7_0.VisibleColor
              hl.OutlineColor = r7_0.VisibleColor
              hl.Enabled = true
            else
              RemoveHighlight(r18_6)
            end
          end
        else
          if r3_6.Character then
            RemoveHighlight(r3_6.Character)
          end
    ...
    r7_0.EspConnections.RemoveEsp = r2_0.PlayerRemoving:Connect(function(r0_1)
      ...
      r1_1.BoxLines = {}
      if r0_1.Character then
        RemoveHighlight(r0_1.Character)
      end
      r6_0[r0_1] = nil
    end)
    return r7_0
  ...
  local WHITELIST_FILE = "lirp_whitelist.json"

  local function SaveWhitelistToFile(whitelist)
    local names = {}
    for name, _ in pairs(whitelist) do
      table.insert(names, name)
    end
    pcall(function()
      writefile(WHITELIST_FILE, HttpService:JSONEncode(names))
    end)
  end
  ...
  local Whitelist = LoadWhitelistFromFile()
  ...
  local function FindBestNameMatch(query)
    ...
    local candidates = {}
    local seen = {}
    for _, plr in ipairs(r7_0:GetPlayers()) do
      if plr ~= r8_0 then
        local n = plr.Name
    ...
    for _, name in ipairs(candidates) do
      if name:lower():sub(1, #q) == q then
        table.insert(startsMatches, name)
      end
    end
    if #startsMatches == 1 then
      return startsMatches[1]
    elseif #startsMatches > 1 then
      table.sort(startsMatches, function(a, b)
        return #a < #b
      end)
      return startsMatches[1]
    end
    ...
    for _, name in ipairs(candidates) do
      if name:lower():find(q, 1, true) then
        table.insert(containsMatches, name)
      end
    end
    if #containsMatches == 1 then
      return containsMatches[1]
    elseif #containsMatches > 1 then
      table.sort(containsMatches, function(a, b)
        local ai = a:lower():find(q, 1, true) or 999
        local bi = b:lower():find(q, 1, true) or 999
        if ai == bi then
          return #a < #b
        end
        return ai < bi
    ...
    for _, name in ipairs(candidates) do
      local dist = levenshtein(q, name:lower())
      local threshold = math.max(2, math.floor(#q * 0.4))
      if dist < bestDist and dist <= threshold then
        bestDist = dist
        bestName = name
      end
    end
  ...
  local function ResolveAndAdd(query)
    if not query or query == "" then
      return false, "Enter a player name first."
    end
    local matched = FindBestNameMatch(query)
    if matched then
      if Whitelist[matched] then
        return false, matched .. " is already whitelisted."
      end
      AddToWhitelist(matched)
      return true, matched
    else
      ...
      AddToWhitelist(raw)
      return true, raw .. " (added as typed)"
    end
  end

  local function ResolveAndRemove(query)
    if not query or query == "" then
      return false, "Enter a player name first."
    end
    local q = query:lower()
    ...
    local matched = FindBestNameMatch(query)
    if matched and Whitelist[matched] then
      RemoveFromWhitelist(matched)
      return true, matched
    end
    local candidates = {}
    for name, _ in pairs(Whitelist) do
    ...
    if #candidates == 1 then
      RemoveFromWhitelist(candidates[1])
    ...
    return false, "No whitelisted player matching '" .. query .. "' found."
  end
  ...
  local function saIsAlive(player)
  ...
  local function saIsVisible(origin, target, ...)
    local ignore = { r9_0, ... }
    if saIsAlive(r8_0) then
      ignore[#ignore + 1] = r8_0.Character
    end
  ...
  local function saGetAi()
    local ai = {}
    local aiZones = workspace:FindFirstChild("AiZones")
    if aiZones then
      for _, v in ipairs(aiZones:GetChildren()) do
        for _, character in ipairs(v:GetChildren()) do
          ai[#ai + 1] = character
        end
      end
    end
  ...
  local function saGetTarget(...)
    local closestTarget, closestDistance = nil, silentAim.Fov.Radius
    for _, character in ipairs(saGetAi()) do
      ...
      if silentAim.WallCheck and not saIsVisible(r9_0.CFrame.Position, hitPart, ...) then
        continue
      end
      local screenPosition, onScreen = r9_0:WorldToViewportPoint(hitPart.Position)
      if not onScreen then
        continue
      end
      local distance = (Vector2.new(screenPosition.X, screenPosition.Y) - r9_0.ViewportSize / 2).Magnitude
      if distance < closestDistance then
        closestDistance = distance
        closestTarget = hitPart
      end
    end
    for index, player in ipairs(r7_0:GetPlayers()) do
      if index == 1 then
        continue
      end
      if not saIsAlive(player) then
        continue
      end
  ...
  local function getBallisticFlightTime(direction, gravity, projectileSpeed)
    local root1, root2 = solveQuadratic(gravity:Dot(gravity) / 4, gravity:Dot(direction) - projectileSpeed ^ 2, direction:Dot(direction))
  ...
  local bulletSuccess, bulletModule = pcall(require, r11_0.Modules.FPS.Bullet)
  if bulletSuccess and bulletModule and hookfunction then
    local oldBullet
    oldBullet = hookfunction(bulletModule.CreateBullet, function(idk, model, model2, model3, aimPart, idk2, ammoType, tick, recoilPattern)
      if silentAim.Enabled then
        local target = saGetTarget(model, model2, model3, aimPart)
        if target then
          local ammoInfo = r11_0.AmmoTypes:FindFirstChild(ammoType)
          if ammoInfo then
            local acceleration = ammoInfo:GetAttribute("ProjectileDrop")
            local projectileSpeed = ammoInfo:GetAttribute("MuzzleVelocity")
            ammoInfo:SetAttribute("Drag", 0)
            local targetPosition = (silentAim.Prediction and predict(target, aimPart.Position, projectileSpeed, acceleration))
              or (not silentAim.Prediction and target.Position)
            local vertical = 0
            local new = { ["CFrame"] = CFrame.new(aimPart.Position, targetPosition + Vector3.new(0, vertical, 0)) }
    ...
    warn("Lirp: Bullet hook with Silent Aim OK")
  else
    warn("Lirp: Bullet hook FAILED")
  end

  silentAim.FOVCircle = Drawing.new("Circle")
  silentAim.FOVCircle.Thickness = 1
  silentAim.FOVCircle.NumSides = 64
  silentAim.FOVCircle.Filled = false
  silentAim.FOVCircle.Color = Color3.fromRGB(255, 100, 100)
  silentAim.FOVCircle.Transparency = 0.5
  silentAim.FOVCircle.Visible = false
  r5_0.RenderStepped:Connect(function()
    silentAim.FOVCircle.Visible = silentAim.Enabled and silentAim.Fov.Visible
    silentAim.FOVCircle.Radius = silentAim.Fov.Radius
    silentAim.FOVCircle.Position = r9_0.ViewportSize / 2
  end)
  ...
  if r4_0 then
    ...
    if r26_0 and r27_0 and r27_0.UpdateKeybinds then
      local origUpdateKeybinds = r27_0.UpdateKeybinds
      function r27_0.UpdateKeybinds(name, key, enabled, active)
        pcall(origUpdateKeybinds, tostring(name or ""), tostring(key or "None"), enabled == true, active == true)
      end
    end
    r28_0 = pcall
    function r29_0()
          ...
          if not (function()
            ...
            if not r39_0 then
              ...
              task.spawn(function()
                ...
                local BulletSilentSector = r7_56.new_sector("Bullet Silent Aim", "Left")
                local WhitelistSector = r12_56.new_sector("Whitelist", "Right")
                ...
                BulletSilentSector.element("Toggle", "Enable Bullet Silent Aim", false, function(r0_sa1)
                  silentAim.Enabled = r0_sa1.Toggle
                end)
                BulletSilentSector.element("Toggle", "Show Bullet Silent FOV", false, function(r0_sa2)
                  silentAim.Fov.Visible = r0_sa2.Toggle
                end)
                BulletSilentSector.element("Toggle", "Bullet Silent Wall Check", false, function(r0_sa3)
                  silentAim.WallCheck = r0_sa3.Toggle
                end)
                BulletSilentSector.element("Toggle", "Bullet Silent Prediction", false, function(r0_sa4)
                  silentAim.Prediction = r0_sa4.Toggle
                end)
                BulletSilentSector.element("Dropdown", "Bullet Silent Target Part", {
                  options = {
                    "Head",
                    "HumanoidRootPart",
                    "UpperTorso",
                  ...
                  silentAim.HitPart = r0_sa5.Dropdown
                end)
                BulletSilentSector.element("Slider", "Bullet Silent FOV Radius", {
                  default = {
                    min = 50,
                    max = 1200,
                    default = 600,
                  ...
                  silentAim.Fov.Radius = r0_sa6.Slider
                end)
                local whitelistInputName = ""
                WhitelistSector.element("TextBox", "Whitelist Player Name", false, function(r0_wl1)
                  whitelistInputName = r0_wl1.Text
                end)
                WhitelistSector.element("Button", "Add to Whitelist", false, function(r0_wl2)
                  local ok, result = ResolveAndAdd(whitelistInputName)
                  r0_0("Whitelist", (ok and "Added: " or "") .. result, 3)
                end)
                WhitelistSector.element("Button", "Add ALL Online", false, function(r0_wl3)
                  local added = 0
                  for _, plr in ipairs(r7_0:GetPlayers()) do
                    if plr ~= r8_0 and not Whitelist[plr.Name] then
                      AddToWhitelist(plr.Name)
                      added = added + 1
                    end
                  end
                  r0_0("Whitelist", "Added " .. added .. " player(s)", 3)
                end)
                WhitelistSector.element("Button", "Show Online Players", false, function(r0_wl4)
                  local names = {}
                  for _, plr in ipairs(r7_0:GetPlayers()) do
                    if plr ~= r8_0 then
                      table.insert(names, (Whitelist[plr.Name] and "[WL] " or "") .. plr.Name)
                    end
                  end
                  r0_0("Online Players", table.concat(names, ", "), 5)
                end)
                local whitelistRemoveName = ""
                WhitelistSector.element("TextBox", "Remove Player Name", false, function(r0_wl5)
                  whitelistRemoveName = r0_wl5.Text
                end)
                WhitelistSector.element("Button", "Remove from Whitelist", false, function(r0_wl6)
                  local ok, result = ResolveAndRemove(whitelistRemoveName)
                  r0_0("Whitelist", (ok and "Removed: " or "") .. result, 3)
                end)
                WhitelistSector.element("Button", "Remove ALL Online", false, function(r0_wl7)
                  local removed = 0
                  for _, plr in ipairs(r7_0:GetPlayers()) do
                    if plr ~= r8_0 and Whitelist[plr.Name] then
                      RemoveFromWhitelist(plr.Name)
                      removed = removed + 1
                    end
                  end
                  r0_0("Whitelist", "Removed " .. removed .. " player(s)", 3)
                end)
                WhitelistSector.element("Button", "Clear Entire Whitelist", false, function(r0_wl8)
                  local count = 0
                  for name, _ in pairs(Whitelist) do
                    Whitelist[name] = nil
                    count = count + 1
                  ...
                  SaveWhitelistToFile(Whitelist)
                  r0_0("Whitelist", "Cleared " .. count .. " player(s)", 3)
                end)
                WhitelistSector.element("Button", "Show All Whitelisted", false, function(r0_wl9)
                  local names = GetWhitelistNames()
                  r0_0("Whitelist (" .. #names .. " players)", #names > 0 and table.concat(names, ", ") or "Empty", 8)
                end)
                WhitelistSector.element("Toggle", "Whitelist ESP Color", false, function(r0_wlcolor)
                end):add_color({
                  Color = Color3.fromRGB(0, 180, 255),
                }, nil, function(r0_wlcol)
                  r25_0.WhitelistESPColor = r0_wlcol.Color
                end)
                ...
                r17_56.element("Toggle", "Visibility ESP Colors", false, function(r0_visesp)
                  r25_0.UseVisibilityColors = r0_visesp.Toggle
                end):add_color({
                  Color = Color3.fromRGB(255, 0, 0),
                }, nil, function(r0_visred)
                  r25_0.VisibleColor = r0_visred.Color
                end)
                r17_56.element("Toggle", "Hidden ESP Color", false, function(r0_vishid)
                end):add_color({
                  Color = Color3.fromRGB(0, 255, 0),
                }, nil, function(r0_visgreen)
                  r25_0.NotVisibleColor = r0_visgreen.Color
                end)
                r17_56.element("Toggle", "Highlight Visible Players", false, function(r0_vishl)
                  r25_0.VisibleHighlight = r0_vishl.Toggle
                end)
          ...
          r39_0.FlipMode = r0_301.Toggle
              ...
              disableFlipMode()
                ...
                task.spawn(function()
                  ...
                  local restoreServerList = nil
                  local filterServers = nil
                  if r39_0.Lobby then
                ...
                local mainMenuGui = r4_0:WaitForChild("unknown", 30)
                local hideBtnGui = Instance.new("ScreenGui")
                hideBtnGui.Name = "LirpHideBtn"
                hideBtnGui.ResetOnSpawn = false
                hideBtnGui.IgnoreGuiInset = true
                hideBtnGui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
                hideBtnGui.DisplayOrder = 999999
                if syn and syn.protect_gui then
                  syn.protect_gui(hideBtnGui)
                end
                hideBtnGui.Parent = r4_0
                local hideBtnFrame = Instance.new("Frame")
                hideBtnFrame.Name = "HideFrame"
                hideBtnFrame.BackgroundTransparency = 1
                hideBtnFrame.Size = UDim2.new(0, 26, 0, 26)
                hideBtnFrame.Position = Load("UDim2", "HideBtnPos.txt") or UDim2.new(1, -34, 1, -34)
                hideBtnFrame.Parent = hideBtnGui
                local hideBtn = Instance.new("TextButton")
                hideBtn.Name = "ToggleHide"
                hideBtn.Size = UDim2.new(1, 0, 1, 0)
                hideBtn.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
                hideBtn.BorderColor3 = Color3.fromRGB(84, 101, 255)
                ...
                local function updateHideBtnText()
                  hideBtn.Text = (mainMenuGui and mainMenuGui.Enabled) and "—" or "+"
                end
                local function toggleMainMenu()
                  if not mainMenuGui then
                    mainMenuGui = r4_0:FindFirstChild("unknown")
                  end
                  if mainMenuGui then
                    mainMenuGui.Enabled = not mainMenuGui.Enabled
                    if r1_56 then
                      r1_56.open = mainMenuGui.Enabled
                    end
                    updateHideBtnText()
                  end
                end
                ...
                local hideBtnDragging = false
                local hideBtnDragStart, hideBtnStartPos
                hideBtn.InputBegan:Connect(function(input)
                  if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
                    hideBtnDragging = true
                    hideBtnDragStart = input.Position
                    hideBtnStartPos = hideBtnFrame.Position
                  end
                end)
                r6_0.InputChanged:Connect(function(input)
                  if hideBtnDragging and (input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch) then
                    local delta = input.Position - hideBtnDragStart
                    hideBtnFrame.Position = UDim2.new(
                      hideBtnStartPos.X.Scale,
                      hideBtnStartPos.X.Offset + delta.X,
                      hideBtnStartPos.Y.Scale,
                      hideBtnStartPos.Y.Offset + delta.Y
                    )
                  end
                end)
                r6_0.InputEnded:Connect(function(input)
                  if not hideBtnDragging then
                    return
                  end
                  if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
                    local moved = (input.Position - hideBtnDragStart).Magnitude
                    hideBtnDragging = false
                    if moved < 6 then
                      toggleMainMenu()
                    else
                      Save(hideBtnFrame.Position, "HideBtnPos.txt")
                    end
                  end
                end)
                hideBtnGui.Enabled = r39_0.HideButtonVisible
                r33_56.element("Toggle", "Show Mini Hide Button", false, function(r0_hide1)
                  r39_0.HideButtonVisible = r0_hide1.Toggle
                  hideBtnGui.Enabled = r0_hide1.Toggle
                end)
                r41_56.element("Button", "Hide / Show Menu", false, function(r0_hide2)
                  toggleMainMenu()
                end)
              ...
              function r122_0()
                ...
                if false then --not r11_0:FindFirstChild(r37_0) then
                  ...
                  if r119_0 then
                    if r118_0 then
                      local guiTitle = r118_0:FindFirstChild("Title")
                      if not guiTitle or guiTitle.Text ~= "Lirp | Project Delta | 2025/11/12 | discord.gg/8RrWuEabnc" then
                        r14_0 = true
                        r22_0("[Script] Crashing Game: GUI Name Changed (" .. (guiTitle and guiTitle.Text or "nil") .. ")", true)
                        Save("92, 33, 33, 33, 23", "InfYield")
                        while true do
                          local r0_273 = math.random() * 100 / 300 * 500000000000000000000000000000000000000000000
                        end
              ...
              r0_0("Lirp 5/5", "Cheat Has Been Loaded Succesfuly.\nBullet Hook: " .. (bulletSuccess and "ENABLED" or "FAILED") .. "\nWhitelisted: " .. wlCount .. " player(s)", 2.5)
              print("=== LIRP LOADED ===")
              print("Bullet Silent Aim:", silentAim.Enabled and "ON" or "OFF")
              print("Whitelist System: ACTIVE")
              print("Whitelisted Players:", wlCount)
              print("Bullet Hook:", bulletSuccess and "CONNECTED" or "FAILED")
